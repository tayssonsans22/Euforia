...
-----------------------------------------------------------------------------------------------------------------------------------------
Hensa = {}
Tunnel.bindInterface("slotmachine", Hensa)
...
-- STARTSLOTS
-----------------------------------------------------------------------------------------------------------------------------------------
function Hensa.StartSlots(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Machines[Table] then
		local Result = {
...
-- WINNER
-----------------------------------------------------------------------------------------------------------------------------------------
function Hensa.Winner(Table, Result)
	local source = source
	local Passport = vRP.Passport(source)
