...
BusLocations = {
	...
	-- vec3(2337.51,2978.25,48.17), PASSA POR DENTRO DA FAVELA
	-- vec3(2270.01,3145.05,48.56), PASSA POR DENTRO DA FAVELA
	-- vec3(1940.04,3312.56,45.34), PASSA POR DENTRO DA FAVELA
