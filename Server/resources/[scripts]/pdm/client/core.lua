...
function CameraActive()
	...
	SetCamCoord(Camera, -43.19,-1094.9,27.26 + 0.5)
	RenderScriptCams(true, true, 100, true, true)
	SetCamRot(Camera, 0.0, 0.0,65.2)
...
RegisterNUICallback("Mount", function(Data, Callback)
	if LoadModel(Data) and LastModel ~= Data then
		...
		Mount = CreateVehicle(Data, -47.8,-1092.01,27.3,308.98, false, false)
...
RegisterNUICallback("Drive", function(Data, Callback)
	if vSERVER.Check() then
		...
		if LoadModel(Data) then
			...
			Mount = CreateVehicle(Data,	-53.11,	-1110.61, 26.67, 68.04, false, false)
