...
-----------------------------------------------------------------------------------------------------------------------------------------
GlobalState["Doors"] = {
	["1"] = { Coords = vec3(444.39,-989.41,30.68), Hash = 185711165, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia", Other = "2" },
	["2"] = { Coords = vec3(445.21,-989.36,30.68), Hash = 185711165, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia", Other = "1" },
	["3"] = { Coords = vec3(450.06,-986.66,30.68), Hash = 1557126584, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia" },
	["4"] = { Coords = vec3(461.75,-993.48,24.9), Hash = 631614199, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia" },
	["5"] = { Coords = vec3(461.82,-1002.21,24.9), Hash = 631614199, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia" },
	["6"] = { Coords = vec3(461.73,-998.61,24.9), Hash = 631614199, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia" },
	["7"] = { Coords = vec3(464.48,-1003.49,24.9), Hash = -1033001619, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia" },
	["8"] = { Coords = vec3(468.18,-1014.51,26.39), Hash = -2023754432, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia", Other = "9" },
	["9"] = { Coords = vec3(468.98,-1014.43,26.39), Hash = -2023754432, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia", Other = "8" },
	["10"] = { Coords = vec3(447.59,-980.03,30.68), Hash = -1320876379, Disabled = false, Lock = true, Distance = 1.5, Perm = "Policia" },
