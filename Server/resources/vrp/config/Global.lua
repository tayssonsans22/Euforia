...
ServerName = "Euforia Roleplay"                                          -- nome do servidor
ReleaseText = "Efetue sua liberação enviando o seu número de whitelist (Obs: Esse não é o seu ID do jogo)" -- texto de liberação da whitelist
...
BackpackWeightPremiumDefault = 50                                       -- peso padrão do inventário Premium
BackpackWeightDefault = 25                                              -- peso padrão do inventário
...
EntityLockdown = "relaxed"                                              -- relaxed / inactive
CanPushCars = true                                                      -- se você pode empurrar veículos presisonando a letra Q
FixedNpcsHasNoCollision = true                                          -- se os npcs fixos possuem colisão
-----------------------------------------------------------------------------------------------------------------------------------------
-- MONEY
-----------------------------------------------------------------------------------------------------------------------------------------
...
NewInitial = false     -- true se você tiver o initial
NewBank = true         -- true se você tiver o nosso bank
NewBankTaxs = false     -- true se você quiser ativar os impostos
NewBankMinTaxs = 1 -- true se quiser ativar os impostos na base com o nosso bank
-----------------------------------------------------------------------------------------------------------------------------------------
-- HUNGER / THIRST
-----------------------------------------------------------------------------------------------------------------------------------------
